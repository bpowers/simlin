...
fn variable_direct_dependencies_impl(
    ...
    match var.kind(db) {
        ...
        _ => {
            ...
            // Lowered bounds-free: the classification walks references, never
            // bounds, and the dependency set is a function of `(variable,
            // project)` -- a shape map would put the owning model's variables
            // on this memo's dependency list.
