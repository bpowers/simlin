...
//
// Proto file SHA256: 6fbae51abf83e584a511b66fd7c790ee0935fecd06b609cd514d559a1031c2ab
...
pub mod variable {
    ...
    pub struct ArrayedEquation {
        ...
        pub default_equation: ::core::option::Option<::prost::alloc::string::String>,
    }
    ...
    pub struct DataSource {
        #[prost(enumeration = "data_source::Kind", tag = "1")]
        pub kind: i32,
        #[prost(string, tag = "2")]
        pub file: ::prost::alloc::string::String,
        #[prost(string, tag = "3")]
        pub tab_or_delimiter: ::prost::alloc::string::String,
        #[prost(string, tag = "4")]
        pub row_or_col: ::prost::alloc::string::String,
        #[prost(string, tag = "5")]
    ...
    pub struct Conveyor {
        /// <len> (required)
        #[prost(string, tag = "1")]
        pub transit_time: ::prost::alloc::string::String,
        /// <capacity>
        #[prost(string, optional, tag = "2")]
        pub capacity: ::core::option::Option<::prost::alloc::string::String>,
        /// <in_limit>
        #[prost(string, optional, tag = "3")]
        pub inflow_limit: ::core::option::Option<::prost::alloc::string::String>,
        /// <sample>
        #[prost(string, optional, tag = "4")]
        pub sample: ::core::option::Option<::prost::alloc::string::String>,
        /// <arrest>
        #[prost(string, optional, tag = "5")]
        pub arrest: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(bool, tag = "6")]
        pub discrete: bool,
        #[prost(bool, tag = "7")]
    ...
    pub struct Leakage {
        ...
        pub fraction: ::core::option::Option<::prost::alloc::string::String>,
        /// <leak_integers/>
        #[prost(bool, tag = "2")]
        pub integers: bool,
        /// leak_start
        #[prost(string, optional, tag = "3")]
        pub zone_start: ::core::option::Option<::prost::alloc::string::String>,
        /// leak_end
        #[prost(string, optional, tag = "4")]
        pub zone_end: ::core::option::Option<::prost::alloc::string::String>,
    }
    /// isee:spreadflow inflow placement method.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct SpreadFlow {
        #[prost(enumeration = "spread_flow::Method", tag = "1")]
        pub method: i32,
        /// graphical-function name for DIST
        #[prost(string, optional, tag = "2")]
        pub distrib_eq: ::core::option::Option<::prost::alloc::string::String>,
    }
    /// Nested message and enum types in `SpreadFlow`.
    pub mod spread_flow {
        #[derive(
            Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration,
        )]
    ...
    pub struct Compat {
        #[prost(string, optional, tag = "1")]
        pub active_initial: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(bool, optional, tag = "2")]
        pub non_negative: ::core::option::Option<bool>,
        #[prost(bool, optional, tag = "3")]
        pub can_be_module_input: ::core::option::Option<bool>,
        #[prost(enumeration = "Visibility", optional, tag = "4")]
        pub visibility: ::core::option::Option<i32>,
        #[prost(message, optional, tag = "5")]
        pub data_source: ::core::option::Option<DataSource>,
        #[prost(message, optional, tag = "6")]
        pub conveyor: ::core::option::Option<Conveyor>,
        #[prost(message, optional, tag = "7")]
        pub leakage: ::core::option::Option<Leakage>,
        #[prost(message, optional, tag = "8")]
        pub spreadflow: ::core::option::Option<SpreadFlow>,
    ...
    pub struct Stock {
        ...
        pub compat: ::core::option::Option<Compat>,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Flow {
        #[prost(string, tag = "1")]
...
pub mod view_element {
    ...
    pub struct Aux {
        ...
        pub label_side: i32,
        #[prost(message, optional, tag = "6")]
        pub compat: ::core::option::Option<ViewElementCompat>,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Stock {
        #[prost(string, tag = "1")]
    ...
    pub struct Flow {
        ...
        pub compat: ::core::option::Option<ViewElementCompat>,
        #[prost(message, optional, tag = "8")]
        pub label_compat: ::core::option::Option<ViewElementCompat>,
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Link {
        #[prost(int32, tag = "1")]
...
pub struct View {
    ...
    pub font: ::core::option::Option<::prost::alloc::string::String>,
}
...
pub struct MacroSpec {
    ...
    pub additional_outputs: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
...
pub struct Model {
    ...
    /// proto3 message field is presence-tracked, so prost generates it as
    /// Option<MacroSpec>.
    #[prost(message, optional, tag = "7")]
    pub macro_spec: ::core::option::Option<MacroSpec>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct Dt {
    #[prost(double, tag = "1")]
...
pub struct Dimension {
    ...
    #[prost(message, repeated, tag = "6")]
    pub mappings: ::prost::alloc::vec::Vec<dimension::DimensionMapping>,
...
pub mod dimension {
    ...
    pub struct DimensionMapping {
        ...
        #[prost(message, repeated, tag = "2")]
        pub entries: ::prost::alloc::vec::Vec<dimension_mapping::ElementMapEntry>,
    }
    /// Nested message and enum types in `DimensionMapping`.
    pub mod dimension_mapping {
        #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
        pub struct ElementMapEntry {
            #[prost(string, tag = "1")]
            pub from_element: ::prost::alloc::string::String,
            #[prost(string, tag = "2")]
            pub to_element: ::prost::alloc::string::String,
        }
    }
