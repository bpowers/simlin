...
//
// Proto file SHA256: 52800bbabcafd21dfda3940f534b681fac5f29e8b711e38292d7f2016b274a67
...
pub mod variable {
    ...
    pub mod data_source {
        ...
        impl Kind {
            ...
            ///
            /// The values are not transformed in any way and thus are considered stable
            /// (if the ProtoBuf definition does not change) and safe for programeli use.
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Data => "DATA",
