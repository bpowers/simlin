...
impl Simulation {
    ...
    ///
    /// Retained for test cross-validation against the incremental path
    /// (`db::compile_project_incremental`), which is now the sole
...
fn test_arrays() {
...

    {
        ...
        let expected: HashMap<_, _> = vec![
            (Ident::new("time"), (0, 1)),
            (Ident::new("dt"), (1, 1)),
            (Ident::new("initial_time"), (2, 1)),
            (Ident::new("final_time"), (3, 1)),
            (Ident::new("aux[a]"), (4, 1)),
            (Ident::new("aux[b]"), (5, 1)),
            (Ident::new("aux[c]"), (6, 1)),
            (Ident::new("constants[a]"), (7, 1)),
            (Ident::new("constants[b]"), (8, 1)),
            (Ident::new("constants[c]"), (9, 1)),
            (Ident::new("picked"), (10, 1)),
            (Ident::new("picked2"), (11, 1)),
        ]
        .into_iter()
        .collect();
    ...
    let expected = Var {
        ident: Ident::new(arrayed_constants_var.ident()),
        ast: vec![
    ...
    let parsed_var: crate::common::Result<Var> = Var::new(
        &Context::new(
            ContextCore {
                dimensions: &converted_dims,
                dimensions_ctx: &parsed_project.dimensions_ctx,
    ...
    assert!(parsed_var.is_ok());
    let expected: Var = Var {
        ident: Ident::new(arrayed_aux_var.ident()),
        ast: vec![
