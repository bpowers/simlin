...
//
// Stdlib SHA256: d235eb68c6f5cb855a33fb51aa7074d965f39c32bc4084e317c5b958c0ef359a
...
fn systems_conversion() -> Model {
    Model {
        ...
        variables: vec![
            ...
            Variable::Aux(Aux {
            ident: "max_src_change".to_string(),
            equation: Equation::Scalar("IF dest_capacity = INF THEN available ELSE MIN(available, MAX(0, INT(dest_capacity / rate)))".to_string()),
            documentation: "".to_string(),
            units: None,
            gf: None,
            ai_state: None,
            ...
            equation: Equation::Scalar("INT(max_src_change * rate)".to_string()),
            documentation: "".to_string(),
            units: None,
            gf: None,
            ai_state: None,
            ...
            equation: Equation::Scalar("available - max_src_change".to_string()),
            documentation: "".to_string(),
            units: None,
            gf: None,
            ai_state: None,
            ...
            equation: Equation::Scalar("max_src_change - outflow".to_string()),
            documentation: "".to_string(),
            units: None,
            gf: None,
            ai_state: None,
