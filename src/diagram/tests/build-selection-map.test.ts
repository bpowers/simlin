...
import { UID } from '@system-dynamics/core/common';
...
describe('Canvas.buildSelectionMap', () => {
  ...
  it('maps selected UIDs to their elements', () => {
    ...
    const result = Canvas.buildSelectionMap(props, elements);
  ...
  it('uses inCreation element when selection contains inCreationUid', () => {
    ...
    const result = Canvas.buildSelectionMap(props, elements, inCreation);
