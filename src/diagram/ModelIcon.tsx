...
interface ModelIconPropsFull {
  className?: string;
}

export const ModelIcon = styled(
  class Model extends React.PureComponent<ModelIconPropsFull> {
    render() {
      ...
      return (
        <svg viewBox="0 0 55 55" className={className} version="1.0">
          <g transform="matrix(1.0162719,0,0,1.0162745,-0.0629825,-0.83188265)" id="g5942">
            <path
              className="simlin-modelicon-initial"
            ...
            />
            <path
              className="simlin-modelicon-red"
  ...
  & .simlin-modelicon-initial {
    fill: none;
    fill-rule: evenodd;
    stroke: none;
  }
  & .simlin-modelicon-red {
    fill: #ffffff;
    stroke: #c83639;
    stroke-width: 3.5px;
