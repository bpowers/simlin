...
use self::datamodel as xmile;
use super::common::{canonicalize, Ident, Result};
use super::datamodel as project;

pub fn from_reader(reader: &mut dyn BufRead) -> Result<Rc<project::Project>> {
    use quick_xml::de;
    ...
    let mut models_list: Vec<project::Model> = self::stdlib::MODEL_NAMES
        .iter()
