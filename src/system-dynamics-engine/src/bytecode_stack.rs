...
pub use crate::bytecode::GraphicalFunctionId;
pub use crate::bytecode::LiteralId;
pub use crate::bytecode::ModuleId;
pub use crate::bytecode::ModuleInputOffset;
pub use crate::bytecode::VariableOffset;

pub(crate) use crate::bytecode::BuiltinId;

#[derive(Clone, Debug)]
pub(crate) enum StackOpcode {
    Add {},
    Sub {},
    Exp {},
    Mul {},
...
pub(crate) use crate::bytecode::ByteCodeContext;
pub(crate) use crate::bytecode::ModuleDeclaration;

#[derive(Clone, Debug, Default)]
pub struct ByteCode {
    pub(crate) literals: Vec<f64>,
    pub(crate) code: Vec<StackOpcode>,
}
...
impl ByteCodeBuilder {
    ...
    pub(crate) fn push_opcode(&mut self, op: StackOpcode) {
...
fn test_opcode_size() {
    use std::mem::size_of;
    assert_eq!(4, size_of::<StackOpcode>());
}

#[derive(Clone, Debug)]
pub struct CompiledStackModule {
