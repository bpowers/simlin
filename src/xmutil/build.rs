...
fn main() {
    ...
    xmutil_build
        ...
        .file("./third_party/xmutil/Dynamo/DYacc.tab.cpp")
        .file("./third_party/xmutil/Dynamo/DynamoFunction.cpp")
        .file("./third_party/xmutil/Dynamo/DynamoLex.cpp")
        .file("./third_party/xmutil/Dynamo/DynamoParse.cpp")
        .file("./third_party/xmutil/Dynamo/DynamoParseFunctions.cpp")
