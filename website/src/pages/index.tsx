      ...
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        <div className="container">
          ...
          <p>
            ...
            policy and strategy much faster (and with fewer costs and consequences) than you can in the real world.
          </p>
