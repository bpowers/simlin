...
- [audits/](audits/) -- Executed analysis notebooks auditing engine behavior against independently-computed ground truth (e.g. the LTM discovery C-LEARN/World3 audits behind the 2026-08-10 design plan)
